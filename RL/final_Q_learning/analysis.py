...
class Analysis(unittest.TestCase):
    ...
    def test_run_optimizer(self):
        optimizer_interface = Optimization(self.net_xml_path, self.user, self.db_path, 20000, 20, self.source_edge,
                                           self.target_edge)
        ...
        with open('ACO_results_parameters-1.csv', 'w', newline='') as file:
