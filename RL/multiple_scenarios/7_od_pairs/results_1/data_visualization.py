...
ax[0].plot(od_pairs, aco_time_cost, marker='o', label='ACO')
ax[0].plot(od_pairs, qlearning_time_cost, marker='s', label='Q-Learning')
ax[0].plot(od_pairs, dqn_time_cost, marker='^', label='DQN')
ax[0].set_xlabel('OD Pairs')
ax[0].set_ylabel('Total Travel Time Cost (seconds)')
ax[0].set_title('Total Travel Time Cost by OD Pairs')
ax[0].legend()

# Execution Time Cost
ax[1].plot(od_pairs, aco_exec_time, marker='o', label='ACO')
ax[1].plot(od_pairs, qlearning_exec_time, marker='s', label='Q-Learning')
ax[1].plot(od_pairs, dqn_exec_time, marker='^', label='DQN')
ax[1].set_xlabel('OD Pairs')
ax[1].set_ylabel('Execution Time Cost (seconds)')
ax[1].set_title('Execution Time Cost by OD Pairs')
ax[1].legend()
