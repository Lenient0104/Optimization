...
class Optimization:
    ...
    def get_stations(self, user):
        ...
        # edge_all = ['361409608#3', '3791905#2', '-11685016#2', '369154722#2', '244844370#0', '37721356#0']
        # edge_two = ['74233405#1', '129774671#0', '23395388#5']
        # edge_one = ['-64270141']

        e_mobility_stations = ['e_bike_1', 'e_scooter_1']
