...
class Environment:
    ...
    def step(self, action_index):
        ...
        if mode == self.last_mode and self.remaining_energy - energy_consumed_new < 0:
        ...
        self.remaining_energy -= energy_consumed_new
...
def infer_best_route(agent, env, max_steps=1000):
    ...
    while steps < max_steps:
        ...
        # print("action:", possible_actions[action])

        next_state, reward, done, info = env.step(action)
        # print("node: ", info['current_node'])
