...
if __name__ == '__main__':
    ...
    with open('results/test', 'w', newline='') as file:
        ...
        writer.writerow(['Experiment ID', 'Episode', 'Execution Time (seconds)', 'Travel Time Cost (seconds)', 'Find'])
        ...
        for episode in episodes:
            ...
            for i in range(test_size):
                ...
                if graph is None:
                    writer.writerow([i + 1, episode, 0, 0, False])
                    continue
                ...
                writer.writerow([experiment_id, episode, execution_time, time_cost, find])
