...
# 加载数据
aco_data = pd.read_csv('Updated_ACO-random.csv')
q_learning_data = pd.read_csv('Updated_Q-learning-fixed.csv')
...
aco_fixed = aco_data[aco_data['E-tools'] == 'Fixed'].reset_index(drop=True)
aco_random = aco_data[aco_data['E-tools'] == 'Random'].reset_index(drop=True)
q_learning_fixed = q_learning_data[q_learning_data['E-tools'] == 'Fixed'].reset_index(drop=True)
q_learning_random = q_learning_data[q_learning_data['E-tools'] == 'Random'].reset_index(drop=True)
