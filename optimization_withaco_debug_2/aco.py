...
class Ant:
    ...
    def __init__(self, start_edge, dest_edge, db_connection, edges, mode='walking'):
        self.edges = edges
        ...
        for next_move in next_moves:
            ...
            if key in edges:
                ...
                if mode != current_mode:
                    ...
                    if mode == 'walking':
                        energy_factor = 1.0
                        heuristic = self.find_edge_length(next_edge)/(self.path_length + self.find_edge_length(next_edge))
                    else:
